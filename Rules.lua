...
function LaFratellanza_ShowRulesFrame()
    ...
    _G["LaFratellanza_Main_Frame_Rules"]:Show();
    _G["LaFratellanza_Main_Frame_Members"]:Hide();
end


function LaFratellanza_RulesFrameInit()
    local rulesFrame = CreateFrame("Frame", "LaFratellanza_Main_Frame_Rules", LaFratellanza_main_frame)
    ...
    local scrollChild = CreateFrame("Frame", "LaFratellanza_Main_Frame_Members_ScrollChild", rulesFrame);
